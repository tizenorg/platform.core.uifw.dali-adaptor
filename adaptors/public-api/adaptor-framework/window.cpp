...
bool Window::GrabKey( KEY keyCode, KeyGrabMode grabMode )
{
  return GetImplementation(*this).GrabKey( keyCode, grabMode );
}

bool Window::UngrabKey( KEY keyCode )
{
  return GetImplementation(*this).UngrabKey( keyCode );
}
