...
namespace InputMethod DALI_IMPORT_API
{
  /**
  ...
  enum Settings
  {
    ACTION_BUTTON_FUNCTION, // ActionButton // Apply the one of the ActionButton functions to the action button (return button)
