...
struct Framework::Impl
{
  ...
  {
    return static_cast<Framework*>(data)->AppStatusHandler(APP_CREATE);
  }
  ...
  {
    static_cast<Framework*>(data)->AppStatusHandler(APP_TERMINATE);
  }
  ...
  {
    static_cast<Framework*>(data)->AppStatusHandler(APP_PAUSE);
  }
  ...
  {
    static_cast<Framework*>(data)->AppStatusHandler(APP_RESUME);
  }
  ...
  {
    static_cast<Framework*>(data)->AppStatusHandler(APP_LANGUAGE_CHANGE);
  }
...
bool Framework::AppStatusHandler(int type)
{
  switch (type)
  {
    case APP_CREATE:
