...
struct Window::Impl : public OrientationObserver
{
   ...
   */
  void SetAdaptor(Dali::Adaptor& adaptor, Window* window);
...
void Window::Impl::SetAdaptor(Dali::Adaptor& adaptor, Window* window)
{
