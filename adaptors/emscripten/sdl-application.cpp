...
bool SdlApplication::DoUpdate( void )
{
  ...
  EmscriptenCallbacks::stats.lastFrameDeltaSeconds = lastFrameDelta;
  EmscriptenCallbacks::stats.lastSyncTimeMilliseconds = lastSyncTime;
  EmscriptenCallbacks::stats.nextSyncTimeMilliseconds = nextSyncTime;

  EmscriptenCallbacks::stats.keepUpdating = status.keepUpdating;
  EmscriptenCallbacks::stats.needsNotification = status.needsNotification;
  EmscriptenCallbacks::stats.secondsFromLastFrame = status.secondsFromLastFrame;
...
void SdlApplication::DoRender()
{
  ...
  EmscriptenCallbacks::stats.frameCount = mFrame;
