...
/**
 * @copydoc Dali::ECore::RenderSurface.
...
public: // from Dali::RenderSurface
   ...
   */
  virtual void PostRender( EglInterface& egl, Integration::GlAbstraction& glAbstraction, DisplayConnection* dc, unsigned int deltaTime, bool replacingSurface );
