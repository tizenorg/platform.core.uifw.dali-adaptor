...
bool Window::GrabKey( Dali::KEY daliKey, Dali::Window::KeyGrabMode grabMode )
{
#ifndef DALI_PROFILE_UBUNTU
  int xGrabMode;
  ...
  int ret = utilx_grab_key (static_cast<Display*>( ecore_x_display_get() ),
                            ...
                            KeyLookup::GetKeyName( daliKey ), xGrabMode);
  return ret==0;
#else
...
bool Window::UngrabKey( Dali::KEY daliKey )
{
#ifndef DALI_PROFILE_UBUNTU
  int ret = utilx_ungrab_key (static_cast<Display*>( ecore_x_display_get()),
                              static_cast<XWindow>( AnyCast<Ecore_X_Window>( GetNativeHandle() ) ),
                              KeyLookup::GetKeyName( daliKey ) );
  return ret==0;
#else
