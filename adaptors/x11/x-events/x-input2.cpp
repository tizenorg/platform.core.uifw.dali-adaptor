...
bool XInput2::PreProcessEvent(  XIDeviceEvent *deviceEvent )
{
...
void XInput2::CreateKeyEvent( const XIDeviceEvent* deviceEvent, KeyEvent& keyEvent ) const
{
  ...
  // extract key symbol. They symbol is typically the name visible on the key
  // e.g. key code 201 might = Brightness increase, or a Korean character depending
  // on the keyboard mapping.
