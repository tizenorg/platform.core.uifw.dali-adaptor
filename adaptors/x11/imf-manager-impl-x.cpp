...
Ecore_IMF_Context* ImfManager::GetContext() const
{
...
Eina_Bool ImfManager::RetrieveSurrounding( void* data, Ecore_IMF_Context* imfContext, char** text, int* cursorPosition )
{
  ...
  Dali::ImfManager::ImfEventData imfData( Dali::ImfManager::GETSURROUNDING , VOID_STRING, 0, 0 );
  Dali::ImfManager handle( this );
...
void ImfManager::DeleteSurrounding( void* data, Ecore_IMF_Context* imfContext, void* event_info )
{
  ...
  if( Dali::Adaptor::IsAvailable() )
  {
    ...
    Dali::ImfManager::ImfEventData imfData( Dali::ImfManager::DELETESURROUNDING , VOID_STRING, deleteSurroundingEvent->offset, deleteSurroundingEvent->n_chars );
    Dali::ImfManager handle( this );
    mEventSignal.Emit( handle, imfData );
  }
}
