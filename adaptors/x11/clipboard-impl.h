...
public: // Signals
   ...
   */
  Dali::Clipboard::ClipboardPasteDataSignalType& PasteDataSignal()
  {
    return mPasteSignal;
  }

  /**
   * Emit the data to paste signal
   * @param[in]  data  The MediaDataType object containing the data
   */
  void EmitPasteDataSignal( MediaDataType data );
...
private:
  ...
  Dali::Clipboard::ClipboardPasteDataSignalType mPasteSignal;
