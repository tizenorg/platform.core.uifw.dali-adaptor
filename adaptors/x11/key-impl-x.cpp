...
// key name definition - definition in utilX.h is deprecated
...
#define KEY_CAMERA              "XF86Camera"            /**< this macro means the XKeySym (XServer Key Symbol) corresponds to 'Half-Press of Camera' key */
#define KEY_CONFIG              "XF86Camera_Full"       /**< this macro means the XKeySym (XServer Key Symbol) corresponds to 'Full-Press of Camera' key */
...
// Renamed 3-Touch key
#define KEY_MENU                "XF86Menu"              /**< this macro means the XKeySym (XServer Key Symbol) corresponds to 'Send' key */
...
#define KEY_SOFTKBD             "XF86SoftKBD"           /**< this macro means the XKeySym (XServer Key Symbol) corresponds to 'Soft keyboard(toggle)' key */
#define KEY_QUICKPANEL          "XF86QuickPanel"        /**< this macro means the XKeySym (XServer Key Symbol) corresponds to 'Quick panel(toggle)' key */
...
#define KEY_APPS                "XF86Apps"              /**< this macro means the XKeySym (XServer Key Symbol) corresponds to 'Apptray(toggle)' key */
#define KEY_SEARCH              "XF86Search"            /**< this macro means the XKeySym (XServer Key Symbol) corresponds to 'Search(toggle)' key */
#define KEY_VOICE               "XF86Voice"             /**< this macro means the XKeySym (XServer Key Symbol) corresponds to 'Voice(toggle)' key */
