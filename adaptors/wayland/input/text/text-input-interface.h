 ...
 *
 * wayland-extension/protocol/text.xml was used for the callback descriptions
 *
 * The events are for from a specific seat and surface.
 *
...
public: // Pointer events. See wl_pointer_listener in wayland-client-protocol.h for more information.
   ...
   * @param[in] index start of the text style
   */
  virtual void PreeditCursor( Seat* seat, uint32_t index ) = 0;
