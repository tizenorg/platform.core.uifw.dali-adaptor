...
public:  // Signals
   ...
   */
  ImfManagerSignalType& ActivatedSignal() { return mActivatedSignalType; }

  /**
   * @copydoc Dali::ImfManager::EventReceivedSignal()
   */
  ImfEventSignalType& EventReceivedSignal() { return mEventSignalType; }
...
private:
  ...
  ImfManagerSignalType      mActivatedSignalType;
  ImfEventSignalType        mEventSignalType;
