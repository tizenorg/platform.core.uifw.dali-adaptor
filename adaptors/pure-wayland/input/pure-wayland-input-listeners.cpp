...
// INTERNAL INCLUDES
#include "pure-wayland-input-interface.h"
...
/************
 *
 * Pointer Events. See wayland-client-protocol.h for a description
 *
 ************/
...
{
  WaylandInputInterface* input = static_cast< WaylandInputInterface* >( data );
...
/************
 *
 * Key Events. See wayland-client-protocol.h for a description
 *
 ************/
...
void KeyFocusLeave( Seat* seat, unsigned int serial, WlSurface* surface )
{
  WaylandInputInterface* input = static_cast< WaylandInputInterface* >( data );
  Seat* seat = input->GetSeat( keyboard );
...
void KeyRepeatInfo( void *data, WlKeyboard* wl_keyboard, int32_t rate, int32_t delay)
{
  WaylandInputInterface* input = static_cast< WaylandInputInterface* >( data );
  Seat* seat = input->GetSeat( keyboard );
...
/************
 *
 * Touch Events. See wayland-client-protocol.h for a description
 *
 ************/
...
void TouchMotion( void *data, WlTouch* touch, unsigned int timestamp, int touchId, wl_fixed_t x, wl_fixed_t y)
{
  ...
  input->TouchMotion( seat, serial, timestamp, touchId, x, y );
}
