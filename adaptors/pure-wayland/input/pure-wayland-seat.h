...
public:
   ...
   */
  Seat( WaylandInputInterface* inputInterface );
   ...
   */
  void SetPointerInterface( InterfaceState state );
   ...
   * @param[in] status of the interface
   */
  void SetTouchInterface( InterfaceState state );
   ...
   * @param[in] status of the interface
   */
  void SetKeyboardInterface( InterfaceState state );
...
private:
  ...
  WaylandInputInterface* mInputInterface;  ///< DALi Wayland Input interface
