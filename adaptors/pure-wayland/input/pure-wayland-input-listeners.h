 ...
 * The listen objects contain C callbacks, which expect the user data-field
 * to be a WaylandInputInterface pointer.
 *
 * E.g. if setting the keyboard listener
 *
 * wl_keyboard_add_listener( keyboard, &Wayland::GetKeyboardListener(), waylandInputInterface );
 *
 */
