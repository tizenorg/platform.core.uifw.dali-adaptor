#ifndef __DALI_PURE_WAYLAND_RENDER_SURFACE_H__
#define __DALI_PURE_WAYLAND_RENDER_SURFACE_H__
...
protected: // Data
  ...
  Internal::Adaptor::WaylandClient*   mWaylandClient; ///< wayland client
