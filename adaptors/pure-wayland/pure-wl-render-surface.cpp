...
void WlRenderSurface::SetPerformanceInterface( Dali::Internal::Adaptor::PerformanceInterface& performanceInterface )
{
  mWaylandClient->SetPerformanceInterface( &performanceInterface );
}
