...
typedef int (*WaylandFlushFuncPtr)(struct wl_display *display);
typedef int (*WaylandDisplayDispatchFuncPtr)(struct wl_display *display);
...
{
  static WaylandFlushFuncPtr funcPtr = NULL;
  if( funcPtr == NULL)
  {
    funcPtr =(WaylandFlushFuncPtr) dlsym(RTLD_NEXT, "wl_display_flush");
  }
...
{
  static WaylandDisplayDispatchFuncPtr funcPtr = NULL;
  if( funcPtr == NULL)
  {
    funcPtr =(WaylandDisplayDispatchFuncPtr) dlsym(RTLD_NEXT, "wl_display_dispatch");
  }
  if( gPerformanceInterface )
  {
...
void WaylandClient::SetPerformanceInterface( PerformanceInterface* performanceInterface)
{
  ...
  gWaylandlDispatchQueue = gPerformanceInterface->AddContext("WL_DISPATCH");
}
