...
public: // Signals
   ...
   */
  IndicatorSignalType& IndicatorVisibilityChangedSignal() { return mIndicatorVisibilityChangedSignalType; }
...
private:
  ...
  // Signals
  IndicatorSignalType mIndicatorVisibilityChangedSignalType;
};
