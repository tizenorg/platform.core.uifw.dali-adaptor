...
public:
  ...
  /**
   * Downcast a handle to a DisplayConnection object.
   *
   * @param[in] handle The handle to cast.
   * @return A handle to a DisplayConnection object or an empty handle.
   */
  static DisplayConnection DownCast(BaseHandle handle);
