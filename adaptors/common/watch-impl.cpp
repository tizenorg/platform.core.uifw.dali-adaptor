...
void WatchApplication::OnTimeTick(void *time)
{
  Dali::WatchApplication watch(this);
  mTickSignal.Emit( watch, (WatchTime *)time );
}

void WatchApplication::OnAmbientTick(void *time)
{
  Dali::WatchApplication watch(this);
  mAmbientTickSignal.Emit( watch, (WatchTime *)time );
}
