...
// Signals
Dali::VirtualKeyboard::StatusSignalType gKeyboardStatusSignalType;
Dali::VirtualKeyboard::VoidSignalType   gKeyboardResizeSignalType;
Dali::VirtualKeyboard::VoidSignalType   gKeyboardLanguageChangedSignalType;
...
void InputPanelStateChangeCallback( void* data, Ecore_IMF_Context* context, int value )
{
  switch (value)
  {
    case ECORE_IMF_INPUT_PANEL_STATE_SHOW:
    {
      ...
      gKeyboardStatusSignalType.Emit( true );
    ...
    case ECORE_IMF_INPUT_PANEL_STATE_HIDE:
    {
      ...
      gKeyboardStatusSignalType.Emit( false );
...
void InputPanelLanguageChangeCallback( void* data, Ecore_IMF_Context* context, int value )
{
  ...
  gKeyboardLanguageChangedSignalType.Emit();
}
...
void InputPanelGeometryChangedCallback ( void *data, Ecore_IMF_Context *context, int value )
{
  ...
  gKeyboardResizeSignalType.Emit();
}
