...
DisplayConnection DisplayConnection::DownCast(BaseHandle handle)
{
  return DisplayConnection(dynamic_cast<Internal::Adaptor::DisplayConnection*>(handle.GetObjectPtr()));
}
...
{
  return GetImpl(*this).GetDisplay();
}
