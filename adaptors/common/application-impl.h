...
public:
   ...
   */
  static ApplicationPtr New( int* argc, char **argv[], const char* stylesheet, WINDOW_MODE windowMode );
...
private:
   ...
   * @param[in]  windowMode  A member of Dali::Application::WINDOW_MODE
   */
  Application( int* argc, char **argv[], const char* stylesheet, WINDOW_MODE windowMode );
