...
{
public:
  typedef Dali::WatchApplication::WatchTime WatchTime;
...
public:
   ...
   * Called every second
   */
  virtual void OnTimeTick(WatchTime& time);

  /**
   * Called every second in ambient mode
   */
  virtual void OnAmbientTick(WatchTime& time);
...
public:
  ...
  WatchApplication& operator=(WatchApplication&);
