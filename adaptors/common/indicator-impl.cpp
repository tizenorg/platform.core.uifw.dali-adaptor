...
void Indicator::Open( Dali::Window::WindowOrientation orientation )
{
  ...
  if(mOrientation == Dali::Window::LANDSCAPE || mOrientation == Dali::Window::LANDSCAPE_INVERSE  ) //@todo add case for translucent when
  {
    mBackgroundActor.SetVisible(false);
  }
  else
