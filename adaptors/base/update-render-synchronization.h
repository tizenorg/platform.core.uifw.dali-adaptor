...
public:
  ...
  */
   ...
   * @param[in] responseActioned True if any responses were actioned, false otherwise
   */
  void RenderFinished( bool updateRequired, bool responseActioned );
...
private:
  ...
  RenderRequest* mRenderRequest;                      ///< Requests for the render thread, e.g. ReplaceSurface
