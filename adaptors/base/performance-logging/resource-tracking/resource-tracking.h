...
public:
   ...
   */
  ResourceTracking( ResourceTrackingManager* resourceTrackingManager );
  ~ResourceTracking();
   ...
   */
  void AddMessage( Dali::ResourceTrackMessage::Type msg,
                   void* ptr,
   ...
   * @param parameter4 4th parameter
   */
  static void AddNewMessage( Dali::ResourceTrackMessage::Type msg,
                             void* ptr,
                             unsigned int parameter1,
                             unsigned int parameter2,
                             unsigned int parameter3,
...
#define DALI_RESOURCE_TRACKING( message, ptr, p1, p2, p3, p4 ) if ( Dali::Internal::Adaptor::g_ResourceTrackingManager ) \
