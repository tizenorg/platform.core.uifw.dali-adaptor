...
void PerformanceServer::AddMarker( MarkerType markerType, ContextId contextId )
{
  ...
  std::string description = mStatContextManager.GetContextName( contextId );
  description+"_"; // E.g. SIZE_NEGOTIATION
  description+=marker.GetName(); // this will be START or END
