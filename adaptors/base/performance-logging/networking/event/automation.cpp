...
int SetProperties( std::string setPropertyMessage )
{
...
std::string DumpVector( Vector2& vec2 )
{
  std::ostringstream msg;
  msg << std::setprecision( 4 ) << "[" << vec2.x << "," << vec2.y << "]";
  //msg << std::setprecision( 4 ) << "[" << vec2 << "]";
  return msg.str();
}

std::string DumpVector( Vector3& vec3 )
{
  std::ostringstream msg;
  msg << std::setprecision( 4 ) << "[" << vec3.x << "," << vec3.y << "," << vec3.z << "]";
//  msg << std::setprecision( 4 )  << "[" << vec3 << "]";
  return msg.str();
}

std::string DumpVector( Vector4& vec4 )
{
  std::ostringstream msg;
  msg << std::setprecision( 4 ) << "[" << vec4.r << "," << vec4.g << "," << vec4.b << "," << vec4.a << "]";
//  msg << std::setprecision( 4 ) << "[" << vec4 << "]";
  return msg.str();
}
...
std::string DumpMatrix( Matrix& matrix )
{
  std::ostringstream msg;
