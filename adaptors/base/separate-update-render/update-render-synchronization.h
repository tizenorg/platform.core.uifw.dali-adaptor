...
#include <integration-api/trigger-event-interface.h>
...
private:
  ...
  volatile int mAllowUpdateWhilePausedCount;          ///< Temporary - countdown to clear flag
  ...
  ConditionalWait mUpdateSleepCondition;    ///< The update thread waits for this condition when sleeping
  ...
  ConditionalWait mVSyncSleepCondition;     ///< The vsync thread waits for this condition
  ConditionalWait mPausedCondition;         ///< The controller waits for this condition while paused
  ConditionalWait mRequestFinishedCondition;///< The controller waits for this condition
  ConditionalWait mRenderRequestSleepCondition;   ///< The render thread waits for this condition
