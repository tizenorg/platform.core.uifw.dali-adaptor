...
public:
  ...
  /**
   * @brief Get whether or not to cumulate gles call statistics
   */
  bool GetGlesCallCumulate() const;
...
private: // Data
  ...
  bool mGlesCallCumulate;                         ///< Whether or not to cumulate gles call statistics
