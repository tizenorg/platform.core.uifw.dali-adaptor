...
public:
   ...
   * Increments internal counter and broadcasts notification to potentially waiting threads
   ...
   * Decrements internal counter and if value is 0, blocks the current thread and returns when Notify is next called.
   * If value is greater than 0, continues
   */
  void Wait();
