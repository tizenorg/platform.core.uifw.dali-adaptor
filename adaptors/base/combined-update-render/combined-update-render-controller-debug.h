...
#define LOG_VSYNC_COUNTER_UPDATE_RENDER(format, args...)    LOG_THREAD_SYNC(DEBUG_LEVEL_COUNTER, COLOR_LIGHT_YELLOW, "%s: " format, __FUNCTION__, ## args)
#else
#define LOG_VSYNC_COUNTER_VSYNC(format, args...)
#define LOG_VSYNC_COUNTER_UPDATE_RENDER(format, args...)
#endif
