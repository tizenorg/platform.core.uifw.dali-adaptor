#ifndef __DALI_ADAPTOR_OFFSCREEN_RENDER_SURFACE_FACTORY_H__
#define __DALI_ADAPTOR_OFFSCREEN_RENDER_SURFACE_FACTORY_H__
...
#endif //  __DALI_ADAPTOR_OFFSCREEN_RENDER_SURFACE_FACTORY_H__
