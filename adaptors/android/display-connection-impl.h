#ifndef __DALI_INTERNAL_ANDROID_DISPLAY_CONNECTION_H__
#define __DALI_INTERNAL_ANDROID_DISPLAY_CONNECTION_H__
...
#endif // __DALI_INTERNAL_ANDROID_DISPLAY_CONNECTION_H__
