...
void NativeBufferRenderSurface::PostRender( EglInterface& egl, Integration::GlAbstraction& glAbstraction, unsigned int timeDelta, bool withSync )
{
  glAbstraction.Flush();
  ...
  DoRenderSync( timeDelta, withSync );
}
