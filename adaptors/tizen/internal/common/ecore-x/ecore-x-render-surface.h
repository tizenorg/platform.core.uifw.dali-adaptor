...
public:  // from Internal::Adaptor::RenderSurface
   ...
   */
  virtual void PostRender( EglInterface& egl, Integration::GlAbstraction& glAbstraction, unsigned int timeDelta, SYNC_MODE syncMode ) = 0;
   ...
   */
  virtual void SetSyncMode( SYNC_MODE syncMode ) { mSyncMode = syncMode; }
...
protected:
   ...
   * @param[in] syncMode Wait for RenderSync (from Adaptor) flag. A member of SYNC_MODE
   */
  void DoRenderSync( unsigned int timeDelta, SYNC_MODE syncMode );
