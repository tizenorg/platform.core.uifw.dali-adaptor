...
public:
   ...
   * @param[in]  core                     The Core object to send events to.
   ...
   */
  EventHandler( RenderSurface* surface, Integration::Core& core, GestureManager& gestureManager, DamageObserver& damageObserver, DragAndDropDetectorPtr dndDetector );
...
private:
  ...
  Dali::Integration::Core& mCore; ///< Reference to the Core, set on construction to send events to.
