...
public: // API
   ...
   */
  virtual void PostRender( EglInterface& egl, Integration::GlAbstraction& glAbstraction, unsigned int deltaTime, SYNC_MODE syncMode ) = 0;
   ...
   * @param[in] syncMode Wait for render sync flag. A member of SYNC_MODE
   */
  virtual void SetSyncMode( SYNC_MODE syncMode ) = 0;
};
