...
#include <base/adaptor-interface.h>
 ...
 */
class Adaptor : public AdaptorInterface, public DamageObserver, public WindowVisibilityObserver
{
public:
...
public: // BaseAdaptor implementation
  /**
