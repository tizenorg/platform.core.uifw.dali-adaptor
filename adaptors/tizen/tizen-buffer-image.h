 ...
 */
class TizenBufferImage : public NativeImageInterface
{
public:
   ...
   */
  DALI_IMPORT_API static TizenBufferImagePtr New( tbm_surface_h* surface = NULL);
   ...
   */
  DALI_IMPORT_API void SetSurface( tbm_surface_h* surface );
