  ...
  mEglImageExtensions( NULL )
{
  ...
  {
    tizenPlatform->SetNativeSourceVertexShaderCode( "platform.SetCustomVertexShaderCode" );
    tizenPlatform->SetNativeSourceFragmentShaderCode( "platform.SetCustomFragmentShaderCode" );
  }
