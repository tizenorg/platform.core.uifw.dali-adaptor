...
public:
 ...
 /**
   ...
   *
   */
//  NativeImage GetVideoStreamImage();
  ...
  /**
   * @brief Sets video display rotation type
   * @SINCE_1_1.24
   *
   * @param[in] rotation The video display rotation type
   */
  void SetDisplayRotation( Dali::VideoPlayerPlugin::DisplayRotation rotation );

  /**
   * @brief Gets video display rotation type
   * @SINCE_1_1.24
   *
