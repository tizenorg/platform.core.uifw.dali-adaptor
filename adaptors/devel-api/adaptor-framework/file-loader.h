...
namespace FileLoader
{
   ...
   *
   */
  char * ReadFile(const std::string& filename, FileLoader::FileType fileType = BINARY);
   ...
   *
   */
  char * ReadFile(const std::string& filename, std::streampos& fileSize , FileLoader::FileType fileType = BINARY);
