 ...
 *
 */
DALI_IMPORT_API char * ReadFile(const std::string& filename, FileLoader::FileType fileType = BINARY);
 ...
 *
 */
DALI_IMPORT_API char * ReadFile(const std::string& filename, std::streampos& fileSize , FileLoader::FileType fileType = BINARY);
