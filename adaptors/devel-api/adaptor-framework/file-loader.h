...
public:
   ...
   */
  static char * ReadFile(const std::string& filename, FileLoader::FileType fileType = BINARY);
   ...
   * NOTE: User is reponsible for freeing the buffer
   */
  static char * ReadFile(const std::string& filename, std::streampos& fileSize , FileLoader::FileType fileType = BINARY);
