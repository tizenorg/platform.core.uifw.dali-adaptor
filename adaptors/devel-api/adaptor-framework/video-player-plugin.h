...
public:
   ...
   */
  virtual bool Forward( int millisecond ) = 0;

  /**
   * @brief Seeks backward by the specified number of milliseconds.
   */
  virtual bool Backward( int millisecond ) = 0;
   ...
   */
  virtual int GetVolume( float* left, float* right ) = 0;
