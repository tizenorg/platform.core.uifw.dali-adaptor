...
int UtcDaliImageOperationsDownscaleInPlacePow2RGBA8888(void)
{
  ...
  DownscaleInPlacePow2RGBA8888( pixels, 600, 600, 75, 75, resultingWidth, resultingHeight );
  DALI_TEST_EQUALS( resultingWidth, 75u, TEST_LOCATION );
  DALI_TEST_EQUALS( resultingHeight, 75u, TEST_LOCATION );

  DownscaleInPlacePow2RGBA8888( pixels, 512, 512, 16, 16, resultingWidth, resultingHeight );
  DALI_TEST_EQUALS( resultingWidth, 16u, TEST_LOCATION );
  DALI_TEST_EQUALS( resultingHeight, 16u, TEST_LOCATION );

  DownscaleInPlacePow2RGBA8888( pixels, 512, 64, 16, 2, resultingWidth, resultingHeight );
  DALI_TEST_EQUALS( resultingWidth, 16u, TEST_LOCATION  );
  DALI_TEST_EQUALS( resultingHeight, 2u, TEST_LOCATION );

  DownscaleInPlacePow2RGBA8888( pixels, 64, 1024, 4, 64, resultingWidth, resultingHeight );
  ...
  DownscaleInPlacePow2RGBA8888( pixels, 601, 603, 75, 75, resultingWidth, resultingHeight );
  DALI_TEST_EQUALS( resultingWidth, 75u, TEST_LOCATION  );
  DALI_TEST_EQUALS( resultingHeight, 75u, TEST_LOCATION );

  DownscaleInPlacePow2RGBA8888( pixels, 736 + 1, 352 + 3, 23, 11, resultingWidth, resultingHeight );
  DALI_TEST_EQUALS( resultingWidth, 23u, TEST_LOCATION  );
  DALI_TEST_EQUALS( resultingHeight, 11u, TEST_LOCATION );

  DownscaleInPlacePow2RGBA8888( pixels, 384 + 3, 896 + 1, 3, 7, resultingWidth, resultingHeight );
  ...
  DownscaleInPlacePow2RGBA8888( pixels, 63, 31, 7, 3, resultingWidth, resultingHeight );
  ...
  DownscaleInPlacePow2RGBA8888( pixels, 63, 31, 4, 2, resultingWidth, resultingHeight );
  DALI_TEST_EQUALS( resultingWidth, 7u, TEST_LOCATION  );
  DALI_TEST_EQUALS( resultingHeight, 3u, TEST_LOCATION );

  // Should stop at almost twice the requested dimensions:
  DownscaleInPlacePow2RGBA8888( pixels, 15, 127, 4, 32, resultingWidth, resultingHeight );
  DALI_TEST_EQUALS( resultingWidth, 7u, TEST_LOCATION  );
...
int UtcDaliImageOperationsDownscaleInPlacePow2RGBA8888Nops(void)
{
  ...
  DownscaleInPlacePow2RGBA8888( pixels, 600, 600, 600, 600, resultingWidth, resultingHeight );
  DALI_TEST_EQUALS( resultingWidth, 600u, TEST_LOCATION );
  DALI_TEST_EQUALS( resultingHeight, 600u, TEST_LOCATION );

  DownscaleInPlacePow2RGBA8888( pixels, 512, 128, 512, 128, resultingWidth, resultingHeight );
  DALI_TEST_EQUALS( resultingWidth, 512u, TEST_LOCATION );
  DALI_TEST_EQUALS( resultingHeight, 128u, TEST_LOCATION );

  DownscaleInPlacePow2RGBA8888( pixels, 17, 1001, 17, 1001, resultingWidth, resultingHeight );
...
int UtcDaliImageOperationsDownscaleInPlacePow2ComponentPair(void)
{
  ...
  TestDownscaleOutputsExpectedDimensions2ComponentPair( image, 600, 600, 37, 37, 37, 37, TEST_LOCATION );
  TestDownscaleOutputsExpectedDimensions2ComponentPair( image, 600, 600, 34, 35, 37, 37, TEST_LOCATION );
...
int UtcDaliImageOperationsDownscaleInPlacePow2SingleBytePerPixel(void)
{
  ...
  TestDownscaleOutputsExpectedDimensionsSingleComponent( image, 600, 300, 150, 75, 150, 75, TEST_LOCATION );
