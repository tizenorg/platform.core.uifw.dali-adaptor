...
#include "platform-abstractions/slp/resource-loader/image-loader-client.h"
...
{
  typedef bool (*LoadBitmapFunction)(FILE*, Dali::Integration::Bitmap&, Dali::ImageAttributes&, const Dali::SlpPlatform::ImageLoaderClient& client);
