#ifndef __DALI_TEXT_ABSTRACTION_TEXT_REORDERING_INTERFACE_H__
#define __DALI_TEXT_ABSTRACTION_TEXT_REORDERING_INTERFACE_H__
...
private:
  ...
  TextReorderingInterface( const TextReorderingInterface& );

  // Undefined assignment operator.
  TextReorderingInterface& operator=( const TextReorderingInterface& );
};
...
#endif // __DALI_TEXT_ABSTRACTION_TEXT_REORDERING_INTERFACE_H__
