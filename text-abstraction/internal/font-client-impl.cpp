...
struct FontClient::Plugin
{
  ...
  void GetSystemFonts( Vector<FontFamilyAndStyle>& systemFonts )
  {
  ...
  _FcFontSet* FontController::GetFcFontSet() const
  {
  ...
  bool FontController::GetFcFontPath( const FcPattern* pattern, FontPath& fontPath )
  {
    FcChar8* file = NULL;
    ...
    if( FcResultMatch == retVal )
    {
      ...
      fontPath.assign( reinterpret_cast<const char*>( file ) );
...
void FontClient::GetSystemFonts( Vector<FontFamilyAndStyle>& systemFonts )
{
  CreatePlugin();
