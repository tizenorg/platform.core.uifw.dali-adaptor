...
{
  Dali::TextAbstraction::Segmentation interface;
  ...
  if ( service )
  {
     ...
     if(handle)
     {
       ...
       interface = Dali::TextAbstraction::Segmentation( impl );
     }
     else // create and register the object
     {
       interface = Dali::TextAbstraction::Segmentation( new Segmentation);
