#ifndef __DALI_TEXT_ABSTRACTION_CLIPBOARD_INTERFACE_H__
#define __DALI_TEXT_ABSTRACTION_CLIPBOARD_INTERFACE_H__
...
#endif // __DALI_TEXT_ABSTRACTION_CLIPBOARD_INTERFACE_H__
