#ifndef __DALI_TOOLKIT_TEXT_ABSTRACTION_CHARACTER_RUN_H__
#define __DALI_TOOLKIT_TEXT_ABSTRACTION_CHARACTER_RUN_H__
...
#endif // __DALI_TOOLKIT_TEXT_ABSTRACTION_CHARACTER_RUN_H__
