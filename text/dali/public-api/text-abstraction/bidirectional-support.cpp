...
BidiInfoIndex BidirectionalSupport::CreateBidirectionalInfo( const Character* const paragraph,
                                                             Length numberOfCharacters )
{
  return 0u;
}

void BidirectionalSupport::DestroyBidirectionalInfo( BidiInfoIndex bidiInfoIndex )
{
}
