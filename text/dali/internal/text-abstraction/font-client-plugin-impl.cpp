...
FontClient::Plugin::FontDescriptionCacheItem::FontDescriptionCacheItem( const FontFamily& _fontFamily,
                                                                        const FontStyle& _fontStyle,
                                                                        FontDescriptionId _index )
: fontFamily( _fontFamily ),
  fontStyle( _fontStyle ),
  index( _index )
{}

FontClient::Plugin::FontIdCacheItem::FontIdCacheItem( FontDescriptionId _validatedFontId,
                                                      PointSize26Dot6 _pointSize,
                                                      FontId _fontId )
: validatedFontId( _validatedFontId ),
