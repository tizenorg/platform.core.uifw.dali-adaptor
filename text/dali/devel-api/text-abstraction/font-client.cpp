...
void FontClient::CreateGlyphyBlob( FontId fontId, GlyphIndex glyphIndex, GlyphyBlob*& blob, unsigned int& blobLength )
{
  GetImplementation(*this).CreateGlyphyBlob( fontId, glyphIndex, blob, blobLength );
}
