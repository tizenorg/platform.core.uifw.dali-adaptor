...
public: // Signal typedefs
  ...
  // @deprecated Use SoundPlayFinishedSignalV2 instead
  //typedef boost::signals2::signal_type< bool (void), DummyMutex >::type TimerSignalType;
  //typedef boost::function<bool (void)> TimerCallbackType;
  //typedef Signal<TimerSignalType, TimerCallbackType> TimerSignalDeprecated;
...
public: // Signals
  ...
  /**
   * @deprecated Use TickSignal() instead.
   */
  //TimerSignalDeprecated SignalTick();
