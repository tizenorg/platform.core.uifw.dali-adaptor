                                                  ...
                                                  Vector2& closestSize )
{
  ...
  Dali::Platform::FileDataHelper file_data = OpenFile(filename);
...
Platform::File* SlpPlatformAbstraction::OpenFile(const std::string& resourcePath) const
{
  Platform::File* file = mResourceLoader->ReadFile(resourcePath);
  return file;
}
...
{
  Dali::Platform::FileDataHelper file_data = OpenFile(resourcePath.c_str());
