...
/** Thrown by CheckForCancellation() to abort a request early. */
...
void ResourceThreadBase::CheckForCancellation() const
{
...
void ResourceThreadBase::ThreadLoop()
{
  ...
  while( !mResourceLoader.IsTerminating() )
  {
    ...
    catch( CancelRequestException& ex ) ///@Todo: Use our own RequestCancelled {} exception.
    {
