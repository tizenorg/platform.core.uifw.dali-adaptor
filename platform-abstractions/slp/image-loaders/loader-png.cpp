...
bool LoadPngHeader(FILE *fp,
    const ImageAttributes& attributes, //@ToDo: Remove this. A high-level caller should apply these attributes uniformly for all formats if it wants to know the result of scaling. This function only needs to know about PNG-specific things.
