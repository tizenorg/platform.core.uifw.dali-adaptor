...
bool LoadJpegHeader(Integration::File *fp, unsigned int &width, unsigned int &height, jpeg_decompress_struct &cinfo, jpeg_error_mgr &jerr)
{
...
bool LoadBitmapFromJpeg(Integration::File *fp, Bitmap& bitmap, ImageAttributes& attributes)
{
