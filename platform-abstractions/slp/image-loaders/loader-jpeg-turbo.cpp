...
bool LoadJpegHeader( Integration::File *fp, unsigned int &width, unsigned int &height )
{
...
bool LoadBitmapFromJpeg( Integration::File *fp, Bitmap& bitmap, ImageAttributes& attributes, const ResourceLoadingClient& client )
{
  const int flags= 0;
...
ExifData* LoadExifData( Integration::File* fp )
{
