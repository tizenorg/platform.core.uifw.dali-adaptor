...
bool LoadBitmapFromJpeg( FILE *fp, Bitmap& bitmap, ImageAttributes& attributes, const ResourceLoadingClient& client )
{
   ...
   *   FORCEMMX  = false;  On Intel, use MMX-optimised codepaths.
   *   FORCESSE  = false;  On Intel, use SSE1-optimised codepaths.
   *   FORCESSE2 = false;  On Intel, use SSE2-optimised codepaths.
   *   FORCESSE3 = false;  On Intel, use SSE3-optimised codepaths.
