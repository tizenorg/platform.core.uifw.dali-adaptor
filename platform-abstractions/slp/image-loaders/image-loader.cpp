...
namespace
{
typedef bool (*LoadBitmapFunction)( Integration::File*, Bitmap&, ImageAttributes&, const ResourceLoadingClient& );
typedef bool (*LoadBitmapHeaderFunction)(Integration::File*, const ImageAttributes& attrs, unsigned int& width, unsigned int& height );
 ...
 */
bool GetBitmapLoaderFunctions( Integration::File *fp,
                               FileFormats format,
...
bool ConvertStreamToBitmap(const ResourceType& resourceType, Integration::File* fp, const ResourceLoadingClient& client, BitmapPtr& ptr)
{
...
ResourcePointer LoadResourceSynchronously( const Integration::ResourceType& resourceType, Integration::File* file_data)
{
