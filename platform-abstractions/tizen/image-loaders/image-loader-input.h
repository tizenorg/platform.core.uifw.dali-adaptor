...
{
public:
  ScalingParameters( ImageDimensions dimensions = ImageDimensions(), ScalingMode scalingMode = ScalingMode(), SamplingMode samplingMode = SamplingMode() ) :
    dimensions(dimensions), scalingMode(scalingMode), samplingMode(samplingMode) {}
