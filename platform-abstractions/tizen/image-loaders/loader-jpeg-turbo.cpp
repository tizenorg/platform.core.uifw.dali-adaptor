  ...
  else
  {
    ...
    if( downscale )
    {
      ...
      for( int i = 1; i < numFactors; ++i )
      {
        ...
        switch( fittingMode )
        {
          // If either scaled dimension is smaller than the desired one, we went too far:
          ...
          // If both dimensions are smaller than the desired one, we went too far:
          ...
          // If the width is smaller than the desired one, we went too far:
          ...
          // We didn't overshoot and scale down too much, so remember this scale factor:
          scaleFactorIndex = i;
        }
      }
    }
