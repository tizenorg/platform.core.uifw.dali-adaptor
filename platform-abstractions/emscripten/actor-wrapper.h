...
public:
  ...
  /* void Insert(int index, ActorWrapper child); API removed */
  ...
  void SetPropertyNotification( Dali::Property::Index index, const std::string& propertyConditionType, float arg0, float arg1);
