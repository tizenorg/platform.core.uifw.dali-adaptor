...
void SetPropertyNoMangling(Dali::Handle& self, const std::string& javascriptName, const Dali::Property::Value& value);

Dali::Property::Value GetPropertyNoMangling(Dali::Handle& self, const std::string& javascriptName);
