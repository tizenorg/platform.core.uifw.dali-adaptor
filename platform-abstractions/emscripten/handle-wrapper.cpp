...
void SetProperty(Dali::Handle& self, const std::string& javascriptName, const Dali::Property::Value& value)
{
  ...
  if( self )
  {
    ...
    Dali::Property::Index index = self.GetPropertyIndex(javascriptName);
    if( Dali::Property::INVALID_INDEX == index )
    {
      index = self.GetPropertyIndex(JavaScriptNameToPropertyName(javascriptName));
    }
...
Dali::Property::Index RegisterPropertyNoMangling(Dali::Handle& self, const std::string& name, const Dali::Property::Value& propertyValue)
{
  ...
  if(self)
  {
    ret = self.RegisterProperty(name, propertyValue);
  }
  return ret;
}

void SetPropertyNoMangling(Dali::Handle& self, const std::string& name, const Dali::Property::Value& value)
{
  DALI_ASSERT_ALWAYS(self);
  if( self )
  {
...
Dali::Property::Value GetPropertyNoMangling(Dali::Handle& self, const std::string& name)
{
  DALI_ASSERT_ALWAYS(self);
  Dali::Property::Value ret;
  if( self )
...
std::vector<std::string> GetProperties(Dali::Handle& self)
{
  ...
  {
    std::string name = PropertyNameToJavaScriptName( self.GetPropertyName( *iter ) );
...
std::string GetPropertyTypeName(Dali::Handle& self, const std::string& name)
{
  if(self)
  {
    Dali::Property::Index index = self.GetPropertyIndex(JavaScriptNameToPropertyName(name));
    if(Dali::Property::INVALID_INDEX != index)
    {
...
std::string GetPropertyTypeNameNoMangling(Dali::Handle& self, const std::string& name)
{
  if(self)
  {
    Dali::Property::Index index = self.GetPropertyIndex(name);
...
Dali::Property::Index RegisterProperty(Dali::Handle& self, const std::string& name, const Dali::Property::Value& propertyValue)
{
  ...
  if(self)
  {
    ret = self.RegisterProperty(JavaScriptNameToPropertyName(name),
