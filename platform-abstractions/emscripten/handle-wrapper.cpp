...
void SetPropertyNoMangling(Dali::Handle& self, const std::string& name, const Dali::Property::Value& value)
{
  ...
  if( self )
  {
    ...
    if( Dali::Property::INVALID_INDEX == index )
    {
      index = self.GetPropertyIndex(name);
    }
...
Dali::Property::Value GetPropertyNoMangling(Dali::Handle& self, const std::string& name)
{
  ...
  if( self )
  {
    ...
    if( Dali::Property::INVALID_INDEX == index )
    {
      index = self.GetPropertyIndex(JavaScriptNameToPropertyName(name));
    }
...
Dali::Property::Type GetPropertyType(Dali::Handle& self, const std::string& name)
{
