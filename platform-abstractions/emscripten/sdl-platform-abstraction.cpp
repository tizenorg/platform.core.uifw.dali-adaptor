...
std::string SdlPlatformAbstraction::GetDefaultFontFamily() const
{
...
const float SdlPlatformAbstraction::GetDefaultFontSize() const
{
  EM_LOG("SdlPlatformAbstraction::GetDefaultFontSize");
  return mGetDefaultFontSizeResult;
}

const PixelSize SdlPlatformAbstraction::GetFontLineHeightFromCapsHeight(const std::string& fontFamily, const std::string& fontStyle, const CapsHeight& capsHeight) const
{
...
std::string SdlPlatformAbstraction::GetFontFamilyForChars(const TextArray& charsRequested) const
{
...
std::vector<std::string> SdlPlatformAbstraction::GetFontList( FontListMode mode ) const
{
