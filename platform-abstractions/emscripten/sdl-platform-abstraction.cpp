...
ImageDimensions SdlPlatformAbstraction::GetClosestImageSize( const std::string& filename,
...
ImageDimensions SdlPlatformAbstraction::GetClosestImageSize( Integration::ResourcePointer resourceBuffer,
                                                             ImageDimensions size,
                                                             FittingMode::Type fittingMode,
                                                             SamplingMode::Type samplingMode,
                                                             bool orientationCorrection )
...
Integration::BitmapPtr SdlPlatformAbstraction::DecodeBuffer( const Integration::ResourceType& resourceType, uint8_t * buffer, size_t bufferSize )
{
...
void SdlPlatformAbstraction::SetDpi (unsigned int // dpiHorizontal
...
bool SdlPlatformAbstraction::LoadFile( const std::string& filename, Dali::Vector< unsigned char >& buffer )  const
{
  EM_LOG("SdlPlatformAbstraction::LoadFile");
  return false;
}

bool SdlPlatformAbstraction::SaveFile( const std::string& filename, const unsigned char * buffer, unsigned int numBytes ) const
{
...
bool SdlPlatformAbstraction::LoadShaderBinaryFile( const std::string& filename, Dali::Vector< unsigned char >& buffer ) const
{
  EM_LOG("SdlPlatformAbstraction::LoadShaderBinaryFile");
  return false;
}

bool SdlPlatformAbstraction::SaveShaderBinaryFile( const std::string& filename, const unsigned char * buffer, unsigned int numBytes ) const
{
  EM_LOG("SdlPlatformAbstraction::SaveShaderBinaryFile");
