...
EMSCRIPTEN_BINDINGS(dali_wrapper)
{
  ...
  // Creation functions.
  //
  emscripten::function("createHandle", &Dali::Internal::Emscripten::CreateHandle);
  emscripten::function("createImage", &Dali::Internal::Emscripten::CreateImage);
...
;
  ...
  class_<Dali::Handle>("Handle")
    .function("__registerProperty", &Dali::Handle::RegisterProperty)
    .function("__registerAnimatedProperty", &Dali::Handle::RegisterAnimatedProperty)
;
...
;
  ...
  class_<Dali::Stage>("Stage")
    ...
    .function("__getLayer", &Dali::Stage::GetLayer)
    .function("getRenderTaskList", &Dali::Stage::GetRenderTaskList)
    .function("__setBackgroundColor", &Dali::Stage::SetBackgroundColor)
;
...
;
  ...
  class_<Dali::Property::Map>("PropertyMap")
    ...
    .function("insert", select_overload< void(const std::string&, const Dali::Property::Value&) > (&Dali::Property::Map::Insert))
    .function("getValue", &Dali::Property::Map::GetValue)
...
;
  ...
  class_<Dali::PropertyBuffer>("PropertyBuffer")
    ...
    .function("setData", &SetPropertyBufferData)
;
