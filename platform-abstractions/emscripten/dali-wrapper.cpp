...
LayerWrapper::LayerWrapper(Layer layer)
  : mLayer(layer), ActorWrapper(layer)
{
...
extern void EmscriptenTouchEvent(double x, double y, int mouseIsDown);
...
;
  ...
  class_<StageWrapper>("Stage")
    ...
    .function("add", &StageWrapper::Add)
    .function("remove", &StageWrapper::Remove)
