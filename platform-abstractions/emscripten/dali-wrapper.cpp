...
void GenerateControlPoints(HandleWrapper& handle, float curvature)
{
  if( handle.Ok() )
  {
    Dali::Path path = Dali::Path::DownCast(handle.GetHandle());
    if(path)
    {
...
;
  ...
  class_<TypeRegistryWrapper>("TypeRegistry")
    .function("getTypeNameCount", &TypeRegistryWrapper::GetTypeNameCount)
    .function("getTypeName", &TypeRegistryWrapper::GetTypeName)
...
;
  ...
  class_<ActorWrapper, base<HandleWrapper>>("ActorWrapper")
    ...
    .function("__connect", &ActorWrapper::ConnectSignal)
    .function("__screenToLocal", &ActorWrapper::ScreenToLocal)
    // .function("insert", &ActorWrapper::Insert) API removed
    ...
    .function("removeShaderEffect", &ActorWrapper::RemoveShaderEffect)
    .function("setPropertyNotification", &ActorWrapper::SetPropertyNotification)
;
