                                          ...
                                          const std::string& fragmentShader )
{
  ...
  ::HandleWrapper(mShaderEffect); // possible?!
}
...
{
  mActor.SetShaderEffect( effect.GetShaderEffect() );
}

ShaderEffectWrapper ActorWrapper::GetShaderEffect() const
{
  return ShaderEffectWrapper( mActor.GetShaderEffect() );
}
...
;
  ...
  class_<AnimationWrapper>("AnimationWrapper")
    ...
    .function("animatePath", &AnimationWrapper::AnimatePath)
;
