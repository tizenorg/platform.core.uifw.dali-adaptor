...
// from javascript values by embind directly. Otherwise objects created must
// have object.delete() called at the correct time.
//
////////////////////////////////////////////////////////////////////////////////
...
EMSCRIPTEN_BINDINGS(dali_wrapper)
{
  ...
  //
  // One convention below is that where there is a funciton or method prepended
  ...
  //
  // Propety value creation (Javascript can't select on type)
  //
