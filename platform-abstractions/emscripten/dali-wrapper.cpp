...
{
// ImageActor CreateSolidColorActor( const Dali::Vector4& color, bool border, const Dali::Vector4& borderColor, const unsigned int borderSize )
// {
  ...
  Dali::BitmapImage imageData = Dali::BitmapImage::New( bitmapWidth, bitmapWidth, Dali::Pixel::RGBA8888 );
...
void ActorWrapper::SetImageData(unsigned int width, unsigned int height, const std::string& data)
{
  ...
  if(imageActor)
  {
    Dali::BitmapImage b = Dali::BitmapImage::New( width, height, Dali::Pixel::RGBA8888 ); // below expects 4 bytes
