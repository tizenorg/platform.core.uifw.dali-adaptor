...
Dali::TypeInfo::NameContainer TypeInfoWrapper::GetProperties()
{
  Dali::TypeInfo::NameContainer names;
  ...
  else
  {
    ...
    names = mInfo.GetProperties();
  }

  // shrink on copy idiom
  Dali::TypeInfo::NameContainer(names).swap(names);
  return names;
}

Dali::TypeInfo::NameContainer TypeInfoWrapper::GetSignals()
{
  return mInfo.GetSignals();
}

Dali::TypeInfo::NameContainer TypeInfoWrapper::GetActions()
{
