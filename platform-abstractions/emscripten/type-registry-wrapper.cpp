...
size_t TypeRegistryWrapper::GetTypeNameCount() const
{
  return Dali::TypeRegistry::Get().GetTypeNameCount();
}

std::string TypeRegistryWrapper::GetTypeName(size_t index) const
{
  return Dali::TypeRegistry::Get().GetTypeName(index);
}
