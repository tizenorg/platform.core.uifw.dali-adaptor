...
dali.Builder.prototype.init = function() {
  ...
  this.propertyBuffers({"imageVerts": {format: [ ["aPosition", dali.PropertyType.VECTOR3],
                                                 ["aTexCoord", dali.PropertyType.VECTOR2] ],
  ...
  for(var i=0; i < builtInImages.length; i++)
  {
    ...
    d = {};
    d["render_" + imageName] = {geometry: "imageGeometry",
...
dali.Builder.prototype.addTo = function() {
  "use strict";
