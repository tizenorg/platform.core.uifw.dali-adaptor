 ...
 */
#define DALI_FUNC_OPT_SPEED_OUTLINE __attribute__((hot))
...
void LinearSample1BPP( const unsigned char * __restrict__ inPixels,
                       ...
                       ImageDimensions desiredDimensions ) DALI_FUNC_OPT_SPEED_OUTLINE;
 ...
 */
inline unsigned int BilinearFilter1Component(unsigned int tl, unsigned int tr, unsigned int bl, unsigned int br, unsigned int fractBlendHorizontal, unsigned int fractBlendVertical ) DALI_FUNC_OPT_SPEED_INLINE_PURE;
