    ...
    unsigned int desiredWidth, unsigned int desiredHeight )
{
  ...
  //const unsigned int deltaX = (uint64_t(inputWidth) << 16u) / desiredWidth;
  //const unsigned int deltaY = (uint64_t(inputHeight) << 16u) / desiredHeight;
