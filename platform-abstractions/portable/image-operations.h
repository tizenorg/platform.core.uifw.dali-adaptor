 ...
 */
// - See Dali core  public api for this:
// - class Vector2Uint16
// - {
// - public:
// -   /**
 ...
 *         have no effect.
 */
Integration::BitmapPtr ApplyAttributesToBitmap( Integration::BitmapPtr bitmap, ImageDimensions dimensions, ScalingMode scalingMode = ScalingMode(), SamplingMode samplingMode = SamplingMode() );
 ...
 **/
Integration::BitmapPtr DownscaleBitmap( Integration::Bitmap& bitmap, ImageDimensions desired, ScalingMode scalingMode, SamplingMode samplingMode );
/**@}*/
