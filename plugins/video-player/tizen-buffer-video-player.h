...
private:
  ...
  Dali::NativeImage mNativeImage;              ///< Video stream image
  ...
  Dali::TizenBufferImagePtr mTbImagePtr;       ///< Video stream image by TBM surface
  Dali::Timer mTimer;                          ///< Timer for updating EGL image
