...
{
  return new Dali::Internal::Adaptor::TizenVideoPlayer();
}
...
const NativeImage& TizenVideoPlayer::GetVideoStreamImage()
{
  return mNativeImage;
}
...
bool TizenVideoPlayer::Update()
{
  ...
  mNativeImageSourcePtr->SetSource( &mTbmsurface );
