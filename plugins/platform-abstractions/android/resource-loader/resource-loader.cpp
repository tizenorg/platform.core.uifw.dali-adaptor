...
struct ResourceLoader::ResourceLoaderImpl
{
  ...
  ResourceLoaderImpl( ResourceLoader* loader )
  {
    ...
    mRequestHandlers.insert(std::make_pair(ResourceNativeImage, new ResourceDummyRequester(*loader)));
    mRequestHandlers.insert(std::make_pair(ResourceTargetImage, new ResourceDummyRequester(*loader)));
  }
...
bool ResourceLoader::ValidateFontFamilyName(const std::string& fontFamily, const std::string& fontStyle, bool& isDefaultSystemFont, std::string& closestFontFamilyMatch, std::string& closestFontStyleMatch)
{
  ...
  closestFontFamilyMatch = "Roboto"; // closestMatch.first;
  closestFontStyleMatch = "Dodgers"; // closestMatch.second;
...
const PixelSize ResourceLoader::GetFontLineHeightFromCapsHeight(const std::string fontFamily, const std::string& fontStyle, const CapsHeight& capsHeight, FT_Library freeType)
{
  ...
  // if (!fontFamily.empty())
  {
    std::string fontFileName = "Roboto-Thin.ttf"; // GetFontPath( fontFamily, fontStyle );
                                        ...
                                        bool getBitmap)
{
  ...
  // if( !fontFamily.empty() )
  {
    ...
    std::string fontFileName = "Roboto-Thin.ttf";
...
Integration::BitmapPtr ResourceLoader::GetGlyphImage( FT_Library freeType, const std::string& fontFamily, const std::string& fontStyle, const float fontSize, const uint32_t character )
{
  ...
  const std::string fontFileName = "Roboto-Thin.ttf";
